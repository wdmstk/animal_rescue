...
- 商用化（法務）: `docs/commercial-legal-ja.md`
- 商用化（運用）: `docs/commercial-operations-ja.md`
- 商用化（事業）: `docs/commercial-business-ja.md`
- 商用化チェックリスト: `docs/commercial-launch-checklist-ja.md`
