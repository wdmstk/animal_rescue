...
const envSchema = z.object({
  ...
  STRIPE_PRICE_ID_ANNUAL_6800: z.string().min(1).optional(),
...
const parsed = envSchema.safeParse({
  ...
  STRIPE_PRICE_ID_ANNUAL_6800: process.env.STRIPE_PRICE_ID_ANNUAL_6800,
...
export const env = {
  ...
  STRIPE_PRICE_ID_ANNUAL_6800: stripePriceIdAnnual6800
};
